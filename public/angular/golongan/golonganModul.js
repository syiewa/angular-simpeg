define(['app'], function(app) {
    ...
    app.controller('editgolonganController', function($scope,$routeParams, dataService) {
    ...
    app.controller('newgolonganController', function($scope, dataService) {
    ...
    app.controller('listgolonganController', function($scope, $filter, dataService) {
        ...
        $scope.edit = function(id) {
            window.location.href = '/golongan/edit/' + id;
        };
